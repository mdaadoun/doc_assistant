...
async def debug_retrieval_endpoint(
    ...
    dense_top_k: int | None = Query(
        default=None, ge=1, description="Dense vector top k"
    ),
    sparse_top_k: int | None = Query(
        default=None, ge=1, description="Sparse BM25 top k"
    ),
    rrf_top_k: int | None = Query(default=None, ge=1, description="RRF fused top k"),
    rerank_top_k: int | None = Query(
        default=None, ge=1, description="Final rerank top k"
    ),
